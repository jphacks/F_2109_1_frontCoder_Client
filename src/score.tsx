    ...
    >
      <Table sx={{ minWidth: 700 }} aria-label="spanning table">
        <TableHead>
          ...
          >
            <TableCell align="right">採点項目</TableCell>
            <TableCell align="right">採点結果</TableCell>
          </TableRow>
          <TableRow>
            <TableCell align="right">デザイン</TableCell>
            <TableCell align="right">40</TableCell>
          </TableRow>
          <TableRow>
            <TableCell align="right">コード</TableCell>
        ...
        <TableBody>
          <TableRow>
            ...
            <TableCell colSpan={2}>
              <Container
                sx={{ fontFamily: '', fontWeight: 'bold', fontSize: '16px' }}
              >
                <Box sx={{ float: 'left' }}>Total</Box>
                <Box sx={{ float: 'right' }}>73</Box>
              </Container>
            </TableCell>
          </TableRow>
        </TableBody>
